...
const Election = () => {
    ...
    const pledge = [
        ...
        "5대 민생공약은 첫째. 내년 정부예산 약607조를 기준으로 총30%를 예산절감추진, 정부예산 혁신운동을 전개하고 이를 통해서 약180조원규모의 절감예산을 중소상공인들과 자영업자, 비정규직노동자, 청년 일자리창출, 출산정책, 등을 위한 특별예산으로 전환 및 적극 지원, 둘째. 전국 약650만 중소상공인, 자영업자를 위한 정책과 예산을 전문적으로 지원하고 애로사항을 중점적으로 해결하는 정부부처를 신설해서 부총리급으로 격상운영, 셋째. 희망자에 한해서 중소상공인들과 자영업자에 1억씩 10년간 무이자 대출 긴급지원(코로나19위기 극복), 넷째. 국회의원수 현행 300명에서 단계적으로 200명으로 축소 및 특권 대폭 축소, 다섯째. 억울한 국민들을 위한 국민신문고 제도 활성화 및 1인 1변호인 정부 무료 책임법률도우미 제도 신설 등 이다.\n\n",
        "△감염병으로 인한 입원 또는 격리 시 유급휴가 의무화 △감염병으로 인한 자녀, 가족 중 장애인과 65세 노인 돌봄에 대한 유급휴가 부여 △감염병으로 인해 직장이 휴업하거나 출근이 금지된 노동자에 대한 유급휴가 부여\n"
    ];

    const [selectedImage, setSelectedImage] = useState(0);
    const [candidate, setCandidate] = useState({
        "party": party[selectedImage],
        "name": name[selectedImage],
        "pledge": pledge[selectedImage]
    });
